...
// #cgo LDFLAGS: -lmingw32 -mwindows -lSDL2main -lSDL2
// #cgo LDFLAGS: -lmingw32 -mwindows -lSDL2main -lSDL2  -lm -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lversion -luuid -ladvapi32 -lsetupapi -lshell32 -ldinput8
// #cgo LDFLAGS: -static
//
// #include <SDL2/SDL.h>
// #include <stdlib.h>
...
import (
	...
	"example.com/gltut_go/sdl2/internal"
)
...
type SDL_Window internal.CObjWrapper[*C.SDL_Window]
...
const (
	...
	//     SDL_WINDOW_MOUSE_GRABBED  SDL_WindowFlags = C./**< window has grabbed mouse input */
	//     SDL_WINDOW_INPUT_FOCUS  SDL_WindowFlags = C./**< window has input focus */
	//     SDL_WINDOW_MOUSE_FOCUS  SDL_WindowFlags = C./**< window has mouse focus */
	//     SDL_WINDOW_FULLSCREEN_DESKTOP  SDL_WindowFlags = C.
	//     SDL_WINDOW_FOREIGN  SDL_WindowFlags = C./**< window not created by SDL */
	//     SDL_WINDOW_ALLOW_HIGHDPI  SDL_WindowFlags = C./**< window should be created in high-DPI mode if supported.
	//                                                      On macOS NSHighResolutionCapable must be set true in the
	//                                                      application's Info.plist for this to have any effect. */
	//     SDL_WINDOW_MOUSE_CAPTURE     SDL_WindowFlags = C./**< window has mouse captured (unrelated to MOUSE_GRABBED) */
	//     SDL_WINDOW_ALWAYS_ON_TOP     SDL_WindowFlags = C./**< window should always be above others */
	//     SDL_WINDOW_SKIP_TASKBAR      SDL_WindowFlags = C./**< window should not be added to the taskbar */
	...
	//     SDL_WINDOW_KEYBOARD_GRABBED  SDL_WindowFlags = C./**< window has grabbed keyboard input */
	//     SDL_WINDOW_VULKAN            SDL_WindowFlags = C./**< window usable for Vulkan surface */
	//     SDL_WINDOW_METAL             SDL_WindowFlags = C./**< window usable for Metal view */
	//     SDL_WINDOW_INPUT_GRABBED  SDL_WindowFlags = C./**< equivalent to SDL_WINDOW_MOUSE_GRABBED for compatibility */
)
...
const (
	SDL_WINDOWPOS_UNDEFINED int = C.SDL_WINDOWPOS_UNDEFINED
)
...
const (
	SDL_WINDOWPOS_CENTERED int = C.SDL_WINDOWPOS_CENTERED
)
...
type _SDL_GLContext internal.CObjWrapper[C.SDL_GLContext]
type SDL_GLContext *_SDL_GLContext
...
const (
	SDL_GL_RED_SIZE                   SDL_GLattr = C.SDL_GL_RED_SIZE
	SDL_GL_GREEN_SIZE                 SDL_GLattr = C.SDL_GL_GREEN_SIZE
	SDL_GL_BLUE_SIZE                  SDL_GLattr = C.SDL_GL_BLUE_SIZE
	SDL_GL_ALPHA_SIZE                 SDL_GLattr = C.SDL_GL_ALPHA_SIZE
	SDL_GL_BUFFER_SIZE                SDL_GLattr = C.SDL_GL_BUFFER_SIZE
	SDL_GL_DOUBLEBUFFER               SDL_GLattr = C.SDL_GL_DOUBLEBUFFER
	SDL_GL_DEPTH_SIZE                 SDL_GLattr = C.SDL_GL_DEPTH_SIZE
	SDL_GL_STENCIL_SIZE               SDL_GLattr = C.SDL_GL_STENCIL_SIZE
	SDL_GL_ACCUM_RED_SIZE             SDL_GLattr = C.SDL_GL_ACCUM_RED_SIZE
	SDL_GL_ACCUM_GREEN_SIZE           SDL_GLattr = C.SDL_GL_ACCUM_GREEN_SIZE
	SDL_GL_ACCUM_BLUE_SIZE            SDL_GLattr = C.SDL_GL_ACCUM_BLUE_SIZE
	SDL_GL_ACCUM_ALPHA_SIZE           SDL_GLattr = C.SDL_GL_ACCUM_ALPHA_SIZE
	SDL_GL_STEREO                     SDL_GLattr = C.SDL_GL_STEREO
	SDL_GL_MULTISAMPLEBUFFERS         SDL_GLattr = C.SDL_GL_MULTISAMPLEBUFFERS
	SDL_GL_MULTISAMPLESAMPLES         SDL_GLattr = C.SDL_GL_MULTISAMPLESAMPLES
	SDL_GL_ACCELERATED_VISUAL         SDL_GLattr = C.SDL_GL_ACCELERATED_VISUAL
	SDL_GL_RETAINED_BACKING           SDL_GLattr = C.SDL_GL_RETAINED_BACKING
	SDL_GL_CONTEXT_MAJOR_VERSION      SDL_GLattr = C.SDL_GL_CONTEXT_MAJOR_VERSION
	SDL_GL_CONTEXT_MINOR_VERSION      SDL_GLattr = C.SDL_GL_CONTEXT_MINOR_VERSION
	SDL_GL_CONTEXT_EGL                SDL_GLattr = C.SDL_GL_CONTEXT_EGL
	SDL_GL_CONTEXT_FLAGS              SDL_GLattr = C.SDL_GL_CONTEXT_FLAGS
	SDL_GL_CONTEXT_PROFILE_MASK       SDL_GLattr = C.SDL_GL_CONTEXT_PROFILE_MASK
	SDL_GL_SHARE_WITH_CURRENT_CONTEXT SDL_GLattr = C.SDL_GL_SHARE_WITH_CURRENT_CONTEXT
	SDL_GL_FRAMEBUFFER_SRGB_CAPABLE   SDL_GLattr = C.SDL_GL_FRAMEBUFFER_SRGB_CAPABLE
	SDL_GL_CONTEXT_RELEASE_BEHAVIOR   SDL_GLattr = C.SDL_GL_CONTEXT_RELEASE_BEHAVIOR
	SDL_GL_CONTEXT_RESET_NOTIFICATION SDL_GLattr = C.SDL_GL_CONTEXT_RESET_NOTIFICATION
	SDL_GL_CONTEXT_NO_ERROR           SDL_GLattr = C.SDL_GL_CONTEXT_NO_ERROR
	SDL_GL_FLOATBUFFERS               SDL_GLattr = C.SDL_GL_FLOATBUFFERS
)
...
const (
	SDL_GL_CONTEXT_PROFILE_CORE          SDL_GLprofile = C.SDL_GL_CONTEXT_PROFILE_CORE
	SDL_GL_CONTEXT_PROFILE_COMPATIBILITY SDL_GLprofile = C.SDL_GL_CONTEXT_PROFILE_COMPATIBILITY
	SDL_GL_CONTEXT_PROFILE_ES            SDL_GLprofile = C.SDL_GL_CONTEXT_PROFILE_ES
)
...
//                                                       int x, int y, int w,
//                                                       int h, Uint32 flags);
func SDL_CreateWindow(title string,
	x, y, w, h int,
	flags uint32,
) *SDL_Window {

	var title_c = C.CString(title)
	defer C.free(unsafe.Pointer(title_c))

	var window_c = C.SDL_CreateWindow(
		title_c,
		C.int(x),
		C.int(y),
		C.int(w),
	...
	return internal.WrapNew[SDL_Window, *C.SDL_Window](window_c)
}
...
//                                                int *h);
func SDL_GetWindowSize(window *SDL_Window, w, h *int) {

	var w_c, h_c C.int
	C.SDL_GetWindowSize(
		internal.Unwrap[SDL_Window, *C.SDL_Window](window),
		&w_c,
		&h_c,
	)
...
func SDL_GetWindowBordersSize(window *SDL_Window, top, left, bottom, right *int) int {

	var top_c, left_c, bottom_c, right_c C.int
	var err = C.SDL_GetWindowBordersSize(
		internal.Unwrap[SDL_Window, *C.SDL_Window](window),
		&top_c,
		&left_c,
		&bottom_c,
...
//                                                        int *w, int *h);
func SDL_GetWindowSizeInPixels(window *SDL_Window, w, h *int) {
...
func SDL_ShowWindow(window *SDL_Window) {
	C.SDL_ShowWindow(internal.Unwrap[SDL_Window, *C.SDL_Window](window))
}
...
func SDL_HideWindow(window *SDL_Window) {
	C.SDL_HideWindow(internal.Unwrap[SDL_Window, *C.SDL_Window](window))
}
...
func SDL_DestroyWindow(window *SDL_Window) {
	C.SDL_DestroyWindow(internal.Unwrap[SDL_Window, *C.SDL_Window](window))
}
...
func SDL_GL_LoadLibrary(path string) int {
	...
	var err = C.SDL_GL_LoadLibrary(path_c)
	return int(err)
}
...
func SDL_GL_GetProcAddress(proc string) unsafe.Pointer {
	var proc_c = C.CString(proc)
	defer C.free(unsafe.Pointer(proc_c))
	return C.SDL_GL_GetProcAddress(proc_c)
}
...
func SDL_GL_ExtensionSupported(extension string) bool {
	var extension_c = C.CString(extension)
	defer C.free(unsafe.Pointer(&extension_c))
	var res = C.SDL_GL_ExtensionSupported(extension_c)
	return 0 != res
}
...
func SDL_GL_SetAttribute(attr SDL_GLattr, value int) int {
	var err = C.SDL_GL_SetAttribute(C.SDL_GLattr(attr), C.int(value))
	return int(err)
}
...
func SDL_GL_CreateContext(window *SDL_Window) SDL_GLContext {
	...
	var ctx = C.SDL_GL_CreateContext(internal.Unwrap[SDL_Window, *C.SDL_Window](window))
	if nil == ctx {
		return nil
	}

	return (SDL_GLContext)(internal.WrapNew[_SDL_GLContext, C.SDL_GLContext](ctx))
}
...
func SDL_GL_MakeCurrent(window *SDL_Window, context SDL_GLContext) int {
	...
	var err = C.SDL_GL_MakeCurrent(
		internal.Unwrap[SDL_Window, *C.SDL_Window](window),
		*internal.Unwrap[_SDL_GLContext, *C.SDL_GLContext]((*_SDL_GLContext)(context)),
	)
...
func SDL_GL_GetCurrentWindow() *SDL_Window {
	var win = C.SDL_GL_GetCurrentWindow()
	if nil == win {
		return nil
	}
	return internal.WrapNew[SDL_Window, *C.SDL_Window](win)
}
...
func SDL_GL_GetCurrentContext() SDL_GLContext {
	var ctx = C.SDL_GL_GetCurrentContext()
	if nil == ctx {
		return nil
	}
	return SDL_GLContext(internal.WrapNew[_SDL_GLContext, C.SDL_GLContext](ctx))
...
//                                                     int *h);
func SDL_GL_GetDrawableSize(window *SDL_Window, w, h *int) {

	var w_c, h_c C.int

	C.SDL_GL_GetDrawableSize(
		internal.Unwrap[SDL_Window, *C.SDL_Window](window),
		&w_c,
		&h_c,
	)
...
func SDL_GL_SwapWindow(window *SDL_Window) {
	C.SDL_GL_SwapWindow(internal.Unwrap[SDL_Window, *C.SDL_Window](window))
}
